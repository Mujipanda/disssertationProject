...
using UnityEngine;
/// <summary>
/// The authoring is responsible for take Monobehaviour variables and baking them into the desired entities.
/// </summary>
...
/// <summary>
/// Responsible for adding the data components to the entites including the monobehaviour data
/// </summary>
